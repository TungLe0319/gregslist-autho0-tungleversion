let auth,https,jsonwebtoken,Cache,BadRequest,Forbidden,Unauthorized;_2dd‍.x([["Auth0Provider",()=>Auth0Provider]]);_2dd‍.w("express-oauth2-jwt-bearer",[["auth",["auth"],function(v){auth=v}]]);_2dd‍.w("https",[["default",["https"],function(v){https=v}]]);_2dd‍.w("jsonwebtoken",[["default",["jsonwebtoken"],function(v){jsonwebtoken=v}]]);_2dd‍.w("node-cache",[["default",["Cache"],function(v){Cache=v}]]);_2dd‍.w("./Errors.js",[["BadRequest",["BadRequest"],function(v){BadRequest=v}],["Forbidden",["Forbidden"],function(v){Forbidden=v}],["Unauthorized",["Unauthorized"],function(v){Unauthorized=v}]]);
